...
listOfMenuItems = [
    new MenuItem("Schedule", "schedule.html#friday"),
    new MenuItemWithSubmenu("Program", [
        new MenuItem("Food & Activities",  "explore_edmonton.html"), new MenuItem("Schedule", "schedule.html#friday"), new MenuItem("Keynotes", "keynotes.html"), new MenuItem("Outstanding&nbspPapers", "RLC2025Awards.html"), new MenuItem("Accepted&nbspWorkshops", "accepted_workshops.html"), new MenuItem("Information&nbspfor&nbspAttendees", "local_info.html"),
