...
listOfMenuItems = [
    ...
    new MenuItemWithSubmenu("Attend", [new MenuItem("Registration", "register.html"),  new MenuItem("Agenda", "agenda.html"),  new MenuItem("Accommodation", "hotels.html"), new MenuItem("Code&nbspof&nbspConduct", "code_of_conduct.html"), new MenuItem("Accepted&nbspPapers", "https://openreview.net/group?id=rl-conference.cc/RLC/2025/Conference#tab-accept")] ),
